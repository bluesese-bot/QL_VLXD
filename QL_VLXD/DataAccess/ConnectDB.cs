...
namespace QL_VLXD.DataAccess
{
    class ConnectDB
    {
        ...
        public ConnectDB()
        {
            try
            {
                StreamReader read = new StreamReader("ConectDB");
        ...
        {
            StreamWriter write = new StreamWriter("ConectDB");
        ...
        public string returnscalarnumberString(string sql)
        {
            con = getcon();
            con.Open();
            sqlcom = new SqlCommand(sql, con);
        ...
        public void LoadTextBox(TextBox box, string SQL)
        {
            con = getcon();
            con.Open();
