...
namespace QL_VLXD.Presentation
{
    public partial class fr_NCC : Form
    {
        ...
        public void hienthi()
        {
            string sql = "SELECT * FROM dbo.tblNhaCungCap";
        ...
        private void msds_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtMMH.Text = msds.Rows[dong].Cells[1].Value.ToString();
            txtten.Text = msds.Rows[dong].Cells[2].Value.ToString();
            txtdt.Text = msds.Rows[dong].Cells[3].Value.ToString();
            txtEmail.Text = msds.Rows[dong].Cells[4].Value.ToString();
            txtdc.Text = msds.Rows[dong].Cells[5].Value.ToString();
            txtNotes.Text= msds.Rows[dong].Cells[6].Value.ToString();
            locktext();
        }

        private void fr_NCC_Load(object sender, EventArgs e)
        {
            cn.LoadLenCombobox(comboBox1, "SELECT TenMatH FROM dbo.tblMatHang", 0);
            locktext();
            hienthi();
            khoitaoluoi();
        }
        ...
        {
            cn.LoadTextBox(txtMMH, "SELECT MaMatH FROM dbo.tblMatHang WHERE TenMatH =N'" + comboBox1.Text + "'");
        }
    }
}
