...
namespace QL_VLXD.Presentation
{
    public partial class fr_HDN : Form
    {
        ...
        {
            string sql = "SELECT * FROM tblChiTietHDN where MaHD = N'" + sohdb + "'";
        ...
        private void msds_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            lbNCC.Text = thucthi1.loadtenncc(lbNCC.Text, cbNCC.Text);
        ...
        private void btnLuu1_Click(object sender, EventArgs e)
        {
            if (cbMatHang.Text != "")
            {
                ...
                string upsl1 = "UPDATE tblMatHang SET gianhap ='" + txtDongia.Text + "' where MaMatH ='" + cbMatHang.Text + "'";
                string uptt = "update tblHoaDonNhap set TongTien=(SELECT sum(ThanhTien) FROM tblChiTietHDN WHERE tblChiTietHDN.MaHD = tblHoaDonNhap.MaHD) where tblHoaDonNhap.MaHD=N'" + txtMHD1.Text + "'";
        ...
        {
            cn.LoadTextBox(txtDongia, "select GiaNhap FROM dbo.tblMatHang WHERE MaMatH= N'"+cbMatHang.Text+"'");
